...
jQuery(document.getElementById('ec_cart_subtotal')).html(response_obj.order_totals.sub_total);if(jQuery('.ec_cart_table_subtotal_amount').length){jQuery('.ec_cart_table_subtotal_amount').html(response_obj.order_totals.sub_total)}
...
if(jQuery(document.getElementById('ec_cart_onepage_payment')).length){jQuery(document.getElementById('ec_cart_onepage_payment')).hide()}}else{jQuery('.ec_cart_left').removeClass('ec_cart_full');jQuery('.ec_cart_right').show();if(jQuery(document.getElementById('ec_cart_onepage_cart')).length){jQuery(document.getElementById('ec_cart_onepage_cart')).hide()}
if(jQuery(document.getElementById('ec_cart_onepage_info')).length){jQuery(document.getElementById('ec_cart_onepage_info')).show()}
if(jQuery(document.getElementById('ec_cart_onepage_shipping')).length){jQuery(document.getElementById('ec_cart_onepage_shipping')).show()}
if(jQuery(document.getElementById('ec_cart_onepage_payment')).length){jQuery(document.getElementById('ec_cart_onepage_payment')).show()}}}else{jQuery('.ec_cart_left').html(response_obj.html_content);if('cart'==page){jQuery('.ec_cart_left').addClass('ec_cart_full');jQuery('.ec_cart_right').hide()}else{jQuery('.ec_cart_left').removeClass('ec_cart_full');jQuery('.ec_cart_right').show()}
...
if(jQuery(document.getElementById(prefix+'_password_retype')).length&&!ec_validate_password(password,retype_password)){errors=!0;ec_show_error(prefix+'_password')}else{ec_hide_error(prefix+'_password')}
